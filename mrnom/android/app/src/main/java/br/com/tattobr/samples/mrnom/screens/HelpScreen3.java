...
public class HelpScreen3 extends Screen {
    ...
    public void present(float deltaTime) {
        ...
        graphics.drawPixmap(AssetsUtil.help3, width / 2 - AssetsUtil.help1.getWidth() / 2, AssetsUtil.HELP_Y);
        graphics.drawPixmap(AssetsUtil.buttons, width - AssetsUtil.BUTTONS_SIZE, height - AssetsUtil.BUTTONS_SIZE, 0, AssetsUtil.BUTTONS_SIZE * 2, AssetsUtil.BUTTONS_SIZE, AssetsUtil.BUTTONS_SIZE);
    }
