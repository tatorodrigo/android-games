...
public class CannonCollisionCameraScreen extends Screen {
    ...
    public CannonCollisionCameraScreen(Game game) {
        super(game);
    ...
    public void update(float deltaTime) {
        ...
        if (ball.position.y > 0) {
            camera2D.position.set(ball.position);
            camera2D.zoom = 1 + ball.position.y / FRUSTUM_HEIGTH;
        } else {
